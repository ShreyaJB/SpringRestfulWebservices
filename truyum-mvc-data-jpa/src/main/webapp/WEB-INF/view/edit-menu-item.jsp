...
<body>
	...
	<form:form action="edit-menu-item" method="post"
		...
		<table class="edit-center">
			<tr>
				<td colspan="4"><label for="name" >Name</label><br> 
				<form:input	size="100" class="name-text-size" path="name"/><br> <span
			...
			<tr>
				...
				<td><label for="Active">Active</label><br> <form:radiobutton
						path="active" value="Yes" />Yes<form:radiobutton path="active"
						value="No" />No</td>
			...
			<tr>
				<td colspan="4"><form:checkbox path="freeDelivery" />
